...
function draw() {
    ...
    for (let i = 0; i < columns; i++) {
        for (let j = 0; j < rows; j++) {
            // if (assumeBoard[i][j] == 1) {
            //     fill(51);  
            //     stroke(strokeColor);
            //     rect(i * unitLength + width, j * unitLength + height, unitLength, unitLength);
            //     console.log(i * unitLength + cwidth, j * unitLength + cheight);
            //     continue;}
            if (currentcolors == 1){
                ...
                else if (currentBoard[i][j] == 0 && assumeBoard[i][j] == 0) {
                    fill(255); //white
                }
            } 
