...
eraser.addEventListener('click', function(){
    if (!erasing){
        erasing = true;
        // document.body.style.backgroundColor = rgb(102, 102, 255)
        document.body.backgroundColor = rgb(102, 102, 255)
    } else {
        erasing = false;
        document.body.style.backgroundColor = rgba(240, 248, 255, 0.57)
    }
})
