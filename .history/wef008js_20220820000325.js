...
//         // selecting = true;
//         if (p.innerHTML == 'Hammerhead'){
//             let width = Math.round(rows / 2 * unitLength - (patterns['fir'][1] * unitLength / 2)); //[1] is max length of each line
//             let height = Math.round(columns/ 2 * unitLength - (patterns['fir'][2] * unitLength / 2)); //[2] is size of lst
...
//         let height = Math.round(columns * unitLength - (patterns['sec'][2] * unitLength)); //[2] is size of lst
//         for (let p of patterns['sec'][0]){
//             for (let innerp of p){
//                 if (innerp == 'O'){
//                     currentBoard[Math.round(width / 2 / unitLength)][Math.round(height / 2 / unitLength)] = 1;
//                 }
//                 width += unitLength;
//             }
//             height += unitLength;
