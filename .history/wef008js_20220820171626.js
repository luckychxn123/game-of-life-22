...
function setup(){
    ...
    nextBoard = [];
    assumeBoard = []; 
    //[back here] this is for pre-confirm mouse/key positioning
    // [here] - func for 
                ...
                if (currentcolors == 1){
                    if (currentBoard[i][j] == 1 && nextBoard[i][j] == 1) {
                        ...
                        for (let b of bulletslst['mouseshoot']){ //[back here]
                            if ((b[1] + 20 > currentBoard[j] * 20 || b[1] < currentBoard[j] * 20+ 20 ) 
                            && (b[2] > currentBoard[i] * 20 - 20 || b[2] - 20 < currentBoard[i] * 20)){
